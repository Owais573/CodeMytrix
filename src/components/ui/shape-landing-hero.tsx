...
function HeroGeometric({
    badge = "AI-Powered Code Generator",
    ...
    return (
        <div className="relative min-h-screen w-full flex items-center justify-center overflow-hidden bg-[#030303] dark:bg-[#030303] bg-background">
                ...
                <div className="max-w-3xl mx-auto text-center">
                    ...
                    >
                        <p className="text-base sm:text-lg md:text-xl text-foreground/40 mb-8 leading-relaxed font-light tracking-wide max-w-xl mx-auto px-4">
                            Generate optimized, bug-free code in multiple programming languages 
